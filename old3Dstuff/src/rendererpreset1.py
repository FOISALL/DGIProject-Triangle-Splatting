...
CFG = {
    ...
    # --- learning rates ---
    "lr_color_opacity_sigma": 5e-4,
    "lr_vertices_init":       3e-4,   # vertex LR at step 0
    "lr_vertices_final":      6e-5,   # vertex LR after decay_steps
    "lr_decay_steps":         2200,
    ...
    "vertex_anchor_weight":   0.035,
    "vertex_anchor_max_offset": 0.5,
    "max_abs_logit": 10.0,
    "min_log_sigma": 0.0,
    "max_log_sigma": 1.3,
    ...
    # --- saving ---
    "checkpoint_path":  "checkpoint_rendererpreset1_stable_debug.pt",   # auto-saved every save_every steps
    "save_every":        100,              # checkpoint interval (steps)
    "save_image_every":  100,              # PNG export interval (steps)
    "image_dir":         "renders_rendererpreset1_debug",        # folder for PNG exports
    ...
    "training_render_dir": "renders_rendererppreset1_training_views",
